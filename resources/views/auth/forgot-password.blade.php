  ...
  >
    ...
    <x-auth-session-status class="mb-4" :status="session('status')" /> {{-- displays feedback box for user --}}
      ...
      <div class=" max-w-md w-full mx-auto px-4 py-8">
        {{-- Button to go back --}}
        <a href="{{ route('login') }}" class="inline-flex items-center text-sm pt-3 pb-16 text-gray-500 transition-colors hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
