      ...
      <div class=" max-w-md w-full mx-auto px-4 py-8">
        ...
        <form method="POST" action="{{ route('register') }}" novalidate>
          ...
          <div class="space-y-5">
            {{-- Name --}}
            <div>
              <x-input-label for="name" :value="__('Name')" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400" />
            ...
            {{-- Email --}}
            <div>
              <x-input-label for="email" :value="__('Email')" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400" />
            ...
            {{-- Birthdate --}}
            <div>
              <x-input-label for="birthdate" :value="__('Birthdate')" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400" />
              <x-text-input id="birthdate" name="birthdate" type="date" required
                            :value="old('birthdate')"
                            class="h-11 w-full rounded-lg border border-gray-400 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:outline-none focus:ring-3 focus:ring-brand-500/10 
                                dark:border-gray-500 dark:bg-gray-900 dark:text-white/90" />
            ...
            <div x-data="{ showPassword: false }">
              ...
              <div class="relative"> {{-- div password dan confirm pass butuh senderan/dinding untuk jadi patokan --}}
                <x-text-input
                  id="password"
                  name="password"
            ...
            <div x-data="{ showConfirm: false }" class="relative">
              <x-input-label for="password_confirmation" :value="__('Confirm Password')" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400" />
              ...
              <div class="relative"> {{-- div password dan confirm pass butuh senderan/dinding untuk jadi patokan --}}
                ...
                <!-- hide/show icons for confirm -->
                <button type="button"
                        @click="showConfirm = !showConfirm"
                        class="absolute right-4 top-1/2 -translate-y-1/2 flex items-center justify-center text-gray-500"
                        :aria-label="showConfirm ? 'Hide confirm password' : 'Show confirm password'">
                  
                        <!-- Eye Open SVG (tampil jika showConfirm = false) -->
                  ...
                  <!-- Eye Closed SVG (tampil jika showConfirm = true) -->
                  <svg x-show="showConfirm" x-cloak xmlns="http://www.w3.org/2000/svg"
                      fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                      class="h-5 w-5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.98 8.223A10.477 10.477 0 0 0 1.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.451 10.451 0 0 1 12 4.5c4.756 0 8.773 3.162 10.065 7.498a10.522 10.522 0 0 1-4.293 5.774M6.228 6.228 3 3m3.228 3.228 3.65 3.65m7.894 7.894L21 21m-3.228-3.228-3.65-3.65m0 0a3 3 0 1 0-4.243-4.243m4.242 4.242L9.88 9.88" />
            ...
            {{-- Checkbox --}}
            <div class="flex my-6 items-center justify-between "> {{-- block make sure it starts on new line --}}
                <label for="agreement" class="flex items-center text-sm font-normal text-gray-700 cursor-pointer select-none dark:text-gray-400">
                  <input id="agreement" 
                        name="agreement" 
                        type="checkbox" 
            ...
            <div class="mt-4 text-center">
              <p class="text-sm font-normal text-gray-700 dark:text-gray-400">
                ...
                <a href="{{ route('login') }}" class="text-indigo-500 hover:text-indigo-700 dark:hover:text-indigo-400">Sign In</a>
              </p>
            </div>
          </div>
        </form>
