...
<x-guest-layout>
    <x-slot name="header">
        <!-- Hero -->
        <div class="pt-8 mb-8">
            <div class=" mx-auto flex flex-col lg:text-left md:flex-row items-center">
                <!-- Left Col -->
                ...
                <div class="w-full md:w-3/5 py-6 text-center">
                    <!-- Use the asset() helper and forward slashes; add alt for accessibility -->
                    <img
    ...
    <x-slot name="fullwidth">
        <!-- Wave SVG Upper part (like separator) -->
        ...
        <section class="bg-white border-b py-8">
            <div class="container max-w-5xl mx-auto m-8">
                {{-- Upper Title with underline --}}
                <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">
                    Title
                </h1>
                <div class="w-full mb-4">
                    <div class="h-1 mx-auto gradient w-64 opacity-50 my-0 py-0 rounded-t bg-gradient-to-r from-indigo-400 to-gray-400"></div>
                </div>

                {{-- SVG and text for "travel booking"--}}
                <div class="flex flex-wrap">
                    <div class="w-5/6 sm:w-1/2 p-6">
                        ...
                        <p class="text-gray-600 mb-8">
                            ...
                            <br /><br />
                            Images from:
                            <a class="text-indigo-400 underline" href="https://undraw.co/">undraw.co</a>
                        </p>
                    </div>
                    ...
                    <div class="w-full sm:w-1/2 p-6">
                        ...
                        <path d="m172 133.75h268v434h-247.58a20.42 20.42 0 0 1 -20.42 -20.42v-413.58z" fill="#818cf8" />
                        ...
                        <circle cx="193" cy="127.75" r="6" fill="#818cf8" />
                        <circle cx="208" cy="127.75" r="6" fill="#818cf8" />
                        <circle cx="223" cy="127.75" r="6" fill="#818cf8" />
                        ...
                        <path
                            ...
                            fill="#3f3d56"
                        />
                        <rect x="604" y="260.14" width="347" height="11" rx="1.24" fill="#818cf8" opacity=".3" />
                        <rect x="604" y="392.07" width="347" height="11" rx="1.24" fill="#818cf8" opacity=".3" />
                        <rect x="878" y="279.75" width="73" height="25" rx="1.24" fill="#818cf8" />
                        <rect x="878" y="411.75" width="73" height="25" rx="1.24" fill="#818cf8" />
                ...
                {{-- SVG and text for "connected world" --}}
                <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                    <div class="w-full sm:w-1/2 p-6 mt-6">
                        ...
                        <path
                            ...
                            stroke-width="2"
                        />
                        <circle cx="214.07" cy="310.65" r="11.968" fill="#818cf8" />
                        <circle cx="322.2" cy="566.52" r="11.968" fill="#818cf8" />
                        <circle cx="780.7" cy="309" r="11.968" fill="#818cf8" />
                        <circle cx="991.17" cy="607.78" r="11.968" fill="#818cf8" />
                        <circle cx="600.35" cy="480.68" r="11.968" fill="#818cf8" />
                        </svg>
                    </div>
        ...
        <section class="bg-white border-b py-8">
            <div class="container mx-auto flex flex-wrap pt-4 pb-12">
                ...
                <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                    ...
                    <button class="mx-auto lg:mx-0 hover:no-underline bg-gradient-to-r from-indigo-400 to-gray-400 text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                        Action
                    </button>
                    </div>
                </div>
        ...
        <section class="bg-gray-100 py-8">
            <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
                ...
                <div class="w-full mb-4">
                <div class="h-1 mx-auto bg-gradient-to-r from-indigo-400 to-gray-400 w-64 opacity-50 my-0 py-0 rounded-t"></div>
                </div>
                ...
                <div class="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-white mt-4 sm:-mt-6 shadow-lg z-10">
                    ...
                    <div class="h-1 w-full bg-gradient-to-r from-indigo-400 to-gray-400 my-0 py-0 rounded-t"></div>
        ...
        <div class="w-full mb-4">
            <div class="h-1 mx-auto bg-white w-1/6 opacity-50 my-0 py-0 rounded-t"></div>
        </div>
        ...
        <footer class="bg-white">
            <div class="container mx-auto px-4">
                <div class="w-full flex flex-wrap md:flex-nowrap py-6 gap-6"> <!-- flex-wrap supaya kolom bisa pindah baris, gap untuk jarak -->
                    <div class="flex-shrink-0 mb-6 mr-12 text-black">
                        <a class="text-indigo-600 no-underline hover:no-underline font-bold text-xl lg:text-3xl flex items-center gap-2" href="#">
                        <img src="{{ asset('images/mlogo.png') }}" alt="Logo" class="h-12 w-auto inline-block align-middle"/>
                        MyPage
                        </a>
                    </div>

                    <!-- setiap kolom boleh shrink, tapi kita beri min-w agar tidak terlalu sempit -->
                    <div class="flex-1 min-w-[160px]">
                        <p class="uppercase text-gray-500 md:mb-6">Links</p>
                        <ul class="mb-6">
                        <li class="mt-2 md:block"><a href="#" class="no-underline hover:underline text-gray-800 hover:text-indigo-500">FAQ</a></li>
                        <li class="mt-2 md:block"><a href="#" class="no-underline hover:underline text-gray-800 hover:text-indigo-500">Help</a></li>
                        <li class="mt-2 md:block"><a href="#" class="no-underline hover:underline text-gray-800 hover:text-indigo-500">Support</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="flex-1 min-w-[140px]">
                        ...
                        <ul class="mb-6">
                        <li class="mt-2 md:block"><a href="#" class="no-underline hover:underline text-gray-800 hover:text-indigo-500">Terms</a></li>
                        <li class="mt-2 md:block"><a href="#" class="no-underline hover:underline text-gray-800 hover:text-indigo-500">Privacy</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="flex-1 min-w-[140px]">
                        ...
                        <ul class="mb-6">
                        <li class="mt-2 md:block"><a href="#" class="no-underline hover:underline text-gray-800 hover:text-indigo-500">Facebook</a></li>
                        <li class="mt-2 md:block"><a href="#" class="no-underline hover:underline text-gray-800 hover:text-indigo-500">Linkedin</a></li>
                        <li class="mt-2 md:block"><a href="#" class="no-underline hover:underline text-gray-800 hover:text-indigo-500">Twitter</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="flex-1 min-w-[140px]">
                        ...
                        <ul class="mb-6">
                        <li class="mt-2 md:block"><a href="#" class="no-underline hover:underline text-gray-800 hover:text-indigo-500">Official Blog</a></li>
                        <li class="mt-2 md:block"><a href="#" class="no-underline hover:underline text-gray-800 hover:text-indigo-500">About Us</a></li>
                        <li class="mt-2 md:block"><a href="#" class="no-underline hover:underline text-gray-800 hover:text-indigo-500">Contact</a></li>
                        </ul>
                    </div>
                </div>
            </div>
